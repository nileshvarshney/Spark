...
if __name__ == "__main__":
    ...
    spark = SparkSession.builder.appName('Sliding Window Stream data groupby timestamp').getOrCreate()
    ...
    convictionPerTimestamp = fileStreamWithTS\
                    .groupBy(window(fileStreamWithTS.timestamp,"30 seconds","18 seconds"))\
                    .agg({"value":"sum"})\
